...
Figure \ref{basicramp} shows the basic experimental configuration of this experiment. The cart was rolled down
a ramp with an attachment on its front. Said attachment modified the cart's cross-sectional area as well as its
aerodynamic properties. 

We can break down the forces experienced by the cart in \ref{basicramp} with the free body diagram...
...
% Text Node
\draw (150,132.41) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,rotate=-12.8]  {$3.14\degree $};
% Text Node
\draw (177,234.4) node [anchor=north west][inner sep=0.75pt]    {$-F_{g}$};
% Text Node
\draw (422,192.9) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$3.14\degree $};
% Text Node
\draw (171.5,214.9) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$mg\sin 3.14\degree $};
% Text Node
\draw (166,208) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,rotate=-283]  {$-mg\cos 3.14\degree $};
% Text Node
