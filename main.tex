...
\shorttitle{Exploring Air Resistance and its Effects on Acceleration}
\author{David Li\\Lab Partner: Bert Sun}
...
\section{Abstract}
In this experiment we studied the effects of increasing the cross-sectional area of a cart on its air resistance, and consequently, its acceleration.
